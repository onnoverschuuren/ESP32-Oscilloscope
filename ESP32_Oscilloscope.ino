...
#define BUTTON_Ok        39 // Top button on LiliyGo T4
#define BUTTON_Plus      37 // Middle button on LiliyGo T4
//#define BUTTON_Minus      //   not used
#define BUTTON_Back      38 // Bottom button on LiliyGo T4
